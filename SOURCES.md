...
This skill consolidates and rebalances content from three community PWA skills:

| Source | Skill | Contribution |
|--------|-------|-------------|
| [jwynia/agent-skills](https://github.com/jwynia/agent-skills) | `pwa-development` | Diagnostic P0–P6 operating model, anti-patterns, caching strategy table, debugging checklist |
